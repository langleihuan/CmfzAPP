...
public class UserController {
    ...
    //
    //@RequestMapping("regist")
    //public String regist(HttpServletRequest request,User user,String captchaCode,String pass2){
    //    String securityCode = (String) request.getSession().getAttribute("securityCode");
    //    if(securityCode.equals(captchaCode)){
    ...
    //            String pwd;
    //            pwd = MD5Utils.getPassword(pass+salt);
    ...
    //        }else{
    //            //若密码不一致则返回注册
    //            throw new RuntimeException("密码两次不一致！");
    //        }
    //    }else{
    //       return  "验证码错误!";
    //    }
